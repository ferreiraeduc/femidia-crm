...
# 🛠️ Femídia CRM — o Sistema Operacional de Vendas com IA, open source, pro WhatsApp
...
[![CI](https://github.com/ferreiraeduc/femidia-crm/actions/workflows/ci.yml/badge.svg)](https://github.com/ferreiraeduc/femidia-crm/actions/workflows/ci.yml)
...
>
> O Femídia CRM foi desenvolvido em **parceria com a HostGator**: o [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
```bash
git clone https://github.com/ferreiraeduc/femidia-crm.git
cd Femídia CRM
...
*"instala o Femídia CRM pra mim"*. Ele lê o [`CLAUDE.md`](hostgator-setup-kit/CLAUDE.md) do kit
...
**Femídia** vem de **Desk** (mesa) + **comm** (comércio): **o comercial de mesa** — toda a operação de vendas do seu negócio numa mesa só, operada por pessoas e agentes de IA juntos.
...
Abra uma [issue](https://github.com/ferreiraeduc/femidia-crm/issues/new/choose) — o template pede o que precisamos (ambiente, `/api/v1/health`, steps). Rodar `bash hostgator-setup-kit/healthcheck.sh` e colar a saída ajuda muito.

Pra **vulnerabilidades de segurança**, **NÃO abra issue pública** — use o [relato privado de vulnerabilidades](https://github.com/ferreiraeduc/femidia-crm/security/advisories/new). Detalhes em [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capabilities do CRM expostas pro ecossistema de agentes: plugue o agente que quiser e ele opera o Femídia.
...
- **Discussões:** [GitHub Discussions](https://github.com/ferreiraeduc/femidia-crm/discussions) — pra perguntas, ideias, showcase.
- **Issues:** [GitHub Issues](https://github.com/ferreiraeduc/femidia-crm/issues) — bugs e tasks.
- **Instagram:** [@ferreiraeduc](https://www.instagram.com/ferreiraeduc)
- **YouTube:** [youtube.com/@ferreiraeduc](https://www.youtube.com/@ferreiraeduc)
...
- **Suporte é comunitário e "as-is".** Dúvidas e bugs entram como
  [Issues](https://github.com/ferreiraeduc/femidia-crm/issues) ou
  [Discussions](https://github.com/ferreiraeduc/femidia-crm/discussions). Não há SLA nem
...
Siga o desenvolvimento: [Instagram](https://www.instagram.com/ferreiraeduc) · [YouTube](https://www.youtube.com/@ferreiraeduc)
