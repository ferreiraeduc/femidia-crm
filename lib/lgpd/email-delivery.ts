 ...
 *
 * Antes desta fase o nome vinha de `args.organizationName ?? "Femídia CRM"`, e
 ...
 * solicitação tinha sido processada pelo Femídia CRM. O campo agora é
 ...
 * era o literal `"Femídia CRM"` e a questão não existia.
 */
