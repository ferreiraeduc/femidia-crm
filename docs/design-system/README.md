# Design System Femídia CRM — Documentação Canônica
...
Esta pasta é a **fonte canônica** da linguagem visual do Femídia CRM. Toda decisão de UI deve consultar estes documentos antes de implementação. Quando houver conflito entre código e doc, **a doc vence** — ajuste o código.
