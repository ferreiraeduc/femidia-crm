...
Inventário completo dos componentes de UI do Femídia CRM. Cada um tem variants finitos, states nomeados e regras de uso. Não fork, não custom-CSS solto: se um componente precisa de variant novo, ele entra aqui.
...
# Componentes custom Femídia CRM
