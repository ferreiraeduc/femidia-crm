...
Femídia CRM tem como persona principal o **atendente que passa 8h/dia na ferramenta**. Decisões importantes:
...
|-----------|-----|-----|----------------------|
| Aerada | 56 | 24 | **Femídia CRM (default)** — uso prolongado, atendimento, navegação tranquila |
...
❌ **Não é Notion exato.** Notion tem padding muito maior em containers (32px+) e linhas aerated principalmente em prose. Femídia CRM aplica Aerada em componentes operacionais (inbox, kanban) e usa space-5/6 em containers.
...
Femídia CRM v1.0 prioriza desktop/tablet. Phone é "view-only mode" (atendente não opera plenamente em phone).
