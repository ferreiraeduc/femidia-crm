...
- **Worktree:** `/Users/rafaelmelgaco/Femídia CRM-crm-vivo`
...
Existem outros worktrees vivos (`.claude/worktrees/*`, `Femídia CRM-qa`, `Femídia CRM-main-preview`,
`Femídia CRM-vendaval*`). **Nenhum deles é seu.** Trabalhe só no worktree acima.

---

## 1. A missão

O Femídia CRM existe para que **todo lead que entra vire uma venda feita ou um problema
