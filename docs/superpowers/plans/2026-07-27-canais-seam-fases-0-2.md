...
**Goal:** Abrir o seam de canal no Femídia CRM — capabilities declarativas, WAHA como primeiro adapter, `provider` no schema e lint anti-vazamento — **sem alterar um único comportamento visível ao usuário**.
