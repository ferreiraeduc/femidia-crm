...
> Femídia CRM via MCP: quais tools existem, o input/output exato de cada uma, a
...
O Femídia CRM expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> Femídia CRM**; o lado do Vendaval é o FG-01.
