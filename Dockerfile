...
# Femídia CRM — imagem de produção self-host (Next.js standalone).
...
LABEL org.opencontainers.image.source="https://github.com/ferreiraeduc/femidia-crm" \
      org.opencontainers.image.licenses="MIT" \
      org.opencontainers.image.title="Femídia CRM"
