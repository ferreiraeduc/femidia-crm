 ...
 *
 * PATCH permite editar: name, message_text, message_variants, daily_limit,
 * throttle_min_ms, throttle_max_ms. Não permite editar contatos ou canais
 * (criação é uma operação separada).
 *
 * Role mínimo: manager.
 */
