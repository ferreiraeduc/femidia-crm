...
async function main() {
  ...
  await p.screenshot({ path: "/private/tmp/claude-501/-Users-rafaelmelgaco-Femídia CRM/10ffaf65-ac1a-4b1b-b62d-368cbdeef6c5/scratchpad/atrito-fase4.png", fullPage: true });
  await b.close();
}
