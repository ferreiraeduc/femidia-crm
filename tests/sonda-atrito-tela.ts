...
const creds = JSON.parse(readFileSync("/Users/rafaelmelgaco/Femídia CRM/.e2e-creds.json", "utf8"));
const EMAIL = creds.users.manager.email;
const SENHA = creds.password;
const OUT = "/private/tmp/claude-501/-Users-rafaelmelgaco-Femídia CRM/10ffaf65-ac1a-4b1b-b62d-368cbdeef6c5/scratchpad";
