...
const c = JSON.parse(readFileSync("/Users/rafaelmelgaco/Femídia CRM/.e2e-creds.json", "utf8"));
async function main() {
  ...
  await p.screenshot({ path: "/private/tmp/claude-501/-Users-rafaelmelgaco-Femídia CRM/10ffaf65-ac1a-4b1b-b62d-368cbdeef6c5/scratchpad/atrito-final.png", fullPage: false });
  await b.close();
}
